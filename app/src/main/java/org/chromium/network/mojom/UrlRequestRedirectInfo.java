...
public final class UrlRequestRedirectInfo extends org.chromium.mojo.bindings.Struct {
    ...
    public static UrlRequestRedirectInfo deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static UrlRequestRedirectInfo deserialize(java.nio.ByteBuffer data) {
    ...
    public static UrlRequestRedirectInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        UrlRequestRedirectInfo result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new UrlRequestRedirectInfo(elementsOrVersion);
        } finally {

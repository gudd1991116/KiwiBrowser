...
class AudioDecoderClient_Internal {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements AudioDecoderClient.Proxy {
...
AudioBuffer buffer) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(ON_BUFFER_DECODED_ORDINAL)));
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<AudioDecoderClient> {

        Stub(org.chromium.mojo.system.Core core, AudioDecoderClient impl) {
            super(core, impl);
        }
    ...
    static final class AudioDecoderClientOnBufferDecodedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static AudioDecoderClientOnBufferDecodedParams deserialize(org.chromium.mojo.bindings.Message message) {
        ...
        public static AudioDecoderClientOnBufferDecodedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }

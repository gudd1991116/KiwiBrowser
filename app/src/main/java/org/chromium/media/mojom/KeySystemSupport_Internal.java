...
IsKeySystemSupportedResponse callback) {
    ...
    static final class KeySystemSupportIsKeySystemSupportedResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static KeySystemSupportIsKeySystemSupportedResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new KeySystemSupportIsKeySystemSupportedResponseParams(elementsOrVersion);
                    ...
                    result.supportedEncryptionSchemes = decoder0.readInts(24, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                    {
                        for (int i0 = 0; i0 < result.supportedEncryptionSchemes.length; ++i0) {
                            EncryptionMode.validate(result.supportedEncryptionSchemes[i0]);
                        }
                    }
                    }
            } finally {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.supportedEncryptionSchemes, 24, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        }
    }
    ...
    static class KeySystemSupportIsKeySystemSupportedResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                mCallback.call(response.isSupported, response.supportedVideoCodecs, response.supportsPersistentLicense, response.supportedEncryptionSchemes);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class KeySystemSupportIsKeySystemSupportedResponseParamsProxyToResponder implements KeySystemSupport.IsKeySystemSupportedResponse {
        ...
        @Override
        public void call(Boolean isSupported, int[] supportedVideoCodecs, Boolean supportsPersistentLicense, int[] supportedEncryptionSchemes) {
            ...
            _response.supportedEncryptionSchemes = supportedEncryptionSchemes;

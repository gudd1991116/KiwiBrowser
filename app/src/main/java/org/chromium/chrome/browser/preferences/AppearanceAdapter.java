...
public class AppearanceAdapter extends BaseAdapter implements OnClickListener {
    ...
    private void refreshData() {
        ...
        mPrepopulatedDescriptions.add("White, and websites can change the toolbar color");
        mPrepopulatedAppearances.add("Diamond Black");
        mPrepopulatedDescriptions.add("Always black");
        mPrepopulatedAppearances.add("Ultra White");
        mPrepopulatedDescriptions.add("A white toolbar (except in night mode)");

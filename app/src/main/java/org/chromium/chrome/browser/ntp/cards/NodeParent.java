...
public interface NodeParent {
     ...
     * @see androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemRangeChanged(int, int, Object)
     */
     ...
     * @see androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemRangeInserted(int, int)
     */
     ...
     * @see androidx.recyclerview.widget.RecyclerView.Adapter#notifyItemRangeRemoved(int, int)
     */

...
public class DownloadLocationDialogBridge implements ModalDialogView.Controller {
    ...
    private boolean downloadWithAdm(WindowAndroid windowAndroid, long totalBytes,
        ...
        if (useAdmIfPossible && !TextUtils.isEmpty(activeDownloadManagerPackageName) && !TextUtils.isEmpty(activeDownloadManagerActivityName) && activeDownloadManagerPackageName.equals("com.bose.meta.browser") != true

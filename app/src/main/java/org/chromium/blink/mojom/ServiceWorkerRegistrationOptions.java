...
public final class ServiceWorkerRegistrationOptions extends org.chromium.mojo.bindings.Struct {
    ...
    public static ServiceWorkerRegistrationOptions deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ServiceWorkerRegistrationOptions deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static ServiceWorkerRegistrationOptions decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new ServiceWorkerRegistrationOptions(elementsOrVersion);
                {

...
public final class ServiceWorkerClientQueryOptions extends org.chromium.mojo.bindings.Struct {
    ...
    public static ServiceWorkerClientQueryOptions deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ServiceWorkerClientQueryOptions deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static ServiceWorkerClientQueryOptions decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new ServiceWorkerClientQueryOptions(elementsOrVersion);
                {

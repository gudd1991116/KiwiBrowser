...
int buffer, org.chromium.gfx.mojom.Size sizeInPixels, org.chromium.mojo.system.SharedBufferHandle sharedBufferHandle) {
            ...
            _message.sizeInPixels = sizeInPixels;

            _message.sharedBufferHandle = sharedBufferHandle;
...
int buffer) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case WRITE_IMAGE_ORDINAL: {
                        ...
                        getImpl().writeImage(data.buffer, data.sizeInPixels, data.sharedBufferHandle);
                        return true;
                    }
    ...
    static final class ClipboardHostWriteImageParams extends org.chromium.mojo.bindings.Struct {
        ...
        public org.chromium.mojo.system.SharedBufferHandle sharedBufferHandle;

        private ClipboardHostWriteImageParams(int version) {
            super(STRUCT_SIZE, version);
            this.sharedBufferHandle = org.chromium.mojo.system.InvalidHandle.INSTANCE;
        }
        ...
        public static ClipboardHostWriteImageParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new ClipboardHostWriteImageParams(elementsOrVersion);
                    ...
                    result.sharedBufferHandle = decoder0.readSharedBufferHandle(12, false);
                    }
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.sharedBufferHandle, 12, false);
            
            encoder0.encode(this.sizeInPixels, 16, false);
        }
    }

...
public final class ManifestIcon extends org.chromium.mojo.bindings.Struct {
    ...
    private ManifestIcon(int version) {
    ...
    public static ManifestIcon deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ManifestIcon deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static ManifestIcon decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new ManifestIcon(elementsOrVersion);
                {
                ...
                result.purpose = decoder0.readInts(32, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                {
                    for (int i0 = 0; i0 < result.purpose.length; ++i0) {
                        ManifestIcon.Purpose.validate(result.purpose[i0]);
                    }
                }
                }
        } finally {

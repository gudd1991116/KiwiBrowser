...
class PublicIpAddressGeolocationProvider_Internal {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements PublicIpAddressGeolocationProvider.Proxy {
...
org.chromium.network.mojom.MutablePartialNetworkTrafficAnnotationTag tag, org.chromium.mojo.bindings.InterfaceRequest<Geolocation> request) {
            ...
            PublicIpAddressGeolocationProviderCreateGeolocationParams _message = new PublicIpAddressGeolocationProviderCreateGeolocationParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(CREATE_GEOLOCATION_ORDINAL)));
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<PublicIpAddressGeolocationProvider> {

        Stub(org.chromium.mojo.system.Core core, PublicIpAddressGeolocationProvider impl) {
            super(core, impl);
        }

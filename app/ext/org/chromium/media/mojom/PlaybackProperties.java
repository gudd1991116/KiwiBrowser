...
public final class PlaybackProperties extends org.chromium.mojo.bindings.Struct {
    ...
    public static PlaybackProperties decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new PlaybackProperties(elementsOrVersion);
                ...
                result.isMuted = decoder0.readBoolean(16, 3);
                }
                {
                    
                result.isMse = decoder0.readBoolean(16, 4);
                }
                {
                    
                result.isEme = decoder0.readBoolean(16, 5);
                }
                {
                    
                result.isEmbeddedMediaExperience = decoder0.readBoolean(16, 6);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.isMuted, 16, 3);
        
        encoder0.encode(this.isMse, 16, 4);
        
        encoder0.encode(this.isEme, 16, 5);
        
        encoder0.encode(this.isEmbeddedMediaExperience, 16, 6);

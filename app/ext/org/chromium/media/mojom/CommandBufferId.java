...
public final class CommandBufferId extends org.chromium.mojo.bindings.Struct {
    ...
    public static CommandBufferId deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static CommandBufferId decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }

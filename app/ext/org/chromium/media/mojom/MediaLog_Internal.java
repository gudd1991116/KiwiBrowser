...
// For:
//     media/mojo/interfaces/media_log.mojom
//
...
class MediaLog_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<MediaLog, MediaLog.Proxy> MANAGER =
            new org.chromium.mojo.bindings.Interface.Manager<MediaLog, MediaLog.Proxy>() {
...
MediaLogEvent event) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(ADD_EVENT_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ADD_EVENT_ORDINAL: {

                        MediaLogAddEventParams data =
                                MediaLogAddEventParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class MediaLogAddEventParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static MediaLogAddEventParams deserialize(org.chromium.mojo.bindings.Message message) {
         ...
         */
        public static MediaLogAddEventParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static MediaLogAddEventParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            MediaLogAddEventParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new MediaLogAddEventParams(elementsOrVersion);
                    {

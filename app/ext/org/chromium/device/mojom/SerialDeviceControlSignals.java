...
public final class SerialDeviceControlSignals extends org.chromium.mojo.bindings.Struct {
    ...
    private SerialDeviceControlSignals(int version) {
    ...
    public static SerialDeviceControlSignals deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static SerialDeviceControlSignals decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }

...
class TimeZoneMonitor_Internal {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements TimeZoneMonitor.Proxy {
...
TimeZoneMonitorClient client) {
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<TimeZoneMonitor> {

        Stub(org.chromium.mojo.system.Core core, TimeZoneMonitor impl) {
            super(core, impl);
        }

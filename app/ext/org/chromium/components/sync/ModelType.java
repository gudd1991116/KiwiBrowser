...
@IntDef({
    ...
    ModelType.ARTICLES, ModelType.APP_LIST, ModelType.WIFI_CREDENTIALS,
    ModelType.SUPERVISED_USER_WHITELISTS, ModelType.ARC_PACKAGE, ModelType.PRINTERS,
    ModelType.READING_LIST, ModelType.USER_EVENTS, ModelType.MOUNTAIN_SHARES, ModelType.PROXY_TABS,
...
public @interface ModelType {
   ...
   */
  int NIGORI = 39;
  int FIRST_CONTROL_MODEL_TYPE = 39;
  /**
   * Flags to enable experimental features.
   */
  int EXPERIMENTS = 40;
  int LAST_CONTROL_MODEL_TYPE = 40;

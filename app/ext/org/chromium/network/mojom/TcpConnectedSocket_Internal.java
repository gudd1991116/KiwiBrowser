...
GetLocalAddressResponse callback) {
            ...
            TcpConnectedSocketGetLocalAddressParams _message = new TcpConnectedSocketGetLocalAddressParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(
                                    ...
                                    0)),
                    new TcpConnectedSocketGetLocalAddressResponseParamsForwardToCallback(callback));
...
UpgradeToTlsResponse callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_LOCAL_ADDRESS_ORDINAL: {
                        ...
                        TcpConnectedSocketGetLocalAddressParams.deserialize(messageWithHeader.getPayload());

                        getImpl().getLocalAddress(new TcpConnectedSocketGetLocalAddressResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
                    ...
                    case UPGRADE_TO_TLS_ORDINAL: {
                        ...
                        getImpl().upgradeToTls(data.hostPortPair, data.trafficAnnotation, data.request, data.observer, new TcpConnectedSocketUpgradeToTlsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class TcpConnectedSocketGetLocalAddressParams extends org.chromium.mojo.bindings.Struct {

        private static final int STRUCT_SIZE = 8;
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(8, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];

        private TcpConnectedSocketGetLocalAddressParams(int version) {
        ...
        public static TcpConnectedSocketGetLocalAddressParams deserialize(org.chromium.mojo.bindings.Message message) {
         ...
         */
        public static TcpConnectedSocketGetLocalAddressParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static TcpConnectedSocketGetLocalAddressParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            TcpConnectedSocketGetLocalAddressParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new TcpConnectedSocketGetLocalAddressParams(elementsOrVersion);
            } finally {
    ...
    static final class TcpConnectedSocketGetLocalAddressResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private TcpConnectedSocketGetLocalAddressResponseParams(int version) {
            super(STRUCT_SIZE, version);
        }
        ...
        public static TcpConnectedSocketGetLocalAddressResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static TcpConnectedSocketGetLocalAddressResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static TcpConnectedSocketGetLocalAddressResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            TcpConnectedSocketGetLocalAddressResponseParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new TcpConnectedSocketGetLocalAddressResponseParams(elementsOrVersion);
                    {
    ...
    static class TcpConnectedSocketGetLocalAddressResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final TcpConnectedSocket.GetLocalAddressResponse mCallback;

        TcpConnectedSocketGetLocalAddressResponseParamsForwardToCallback(TcpConnectedSocket.GetLocalAddressResponse callback) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                TcpConnectedSocketGetLocalAddressResponseParams response = TcpConnectedSocketGetLocalAddressResponseParams.deserialize(messageWithHeader.getPayload());
    ...
    static class TcpConnectedSocketGetLocalAddressResponseParamsProxyToResponder implements TcpConnectedSocket.GetLocalAddressResponse {
        ...
        TcpConnectedSocketGetLocalAddressResponseParamsProxyToResponder(
        ...
        public void call(Integer netError, org.chromium.net.interfaces.IpEndPoint localAddr) {
            TcpConnectedSocketGetLocalAddressResponseParams _response = new TcpConnectedSocketGetLocalAddressResponseParams();

...
public final class NetworkContextParams extends org.chromium.mojo.bindings.Struct {
    ...
    private NetworkContextParams(int version) {
        ...
        this.allowGssapiLibraryLoad = (boolean) false;
    ...
    public static NetworkContextParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new NetworkContextParams(elementsOrVersion);
                ...
                result.restoreOldSessionCookies = decoder0.readBoolean(32, 1);
                }
                {
                    
                result.persistSessionCookies = decoder0.readBoolean(32, 2);
                }
                {
                    
                result.httpCacheEnabled = decoder0.readBoolean(32, 3);
                }
                {
                    
                result.enableDataUrlSupport = decoder0.readBoolean(32, 4);
                }
                {
                    
                result.enableFileUrlSupport = decoder0.readBoolean(32, 5);
                }
                {
                    
                result.enableFtpUrlSupport = decoder0.readBoolean(32, 6);
                }
                {
                    
                result.enforceChromeCtPolicy = decoder0.readBoolean(32, 7);
                }
                {
                    
                result.http09OnNonDefaultPortsEnabled = decoder0.readBoolean(33, 0);
                }
                {
                    
                result.pacQuickCheckEnabled = decoder0.readBoolean(33, 1);
                }
                {
                    
                result.dangerouslyAllowPacAccessToSecureUrls = decoder0.readBoolean(33, 2);
                }
                {
                    
                result.allowGssapiLibraryLoad = decoder0.readBoolean(33, 3);
                }
                {
                    
                result.enableCertificateReporting = decoder0.readBoolean(33, 4);
                }
                {
                ...
                result.gssapiLibraryName = decoder0.readString(128, false);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.restoreOldSessionCookies, 32, 1);
        
        encoder0.encode(this.persistSessionCookies, 32, 2);
        
        encoder0.encode(this.httpCacheEnabled, 32, 3);
        
        encoder0.encode(this.enableDataUrlSupport, 32, 4);
        
        encoder0.encode(this.enableFileUrlSupport, 32, 5);
        
        encoder0.encode(this.enableFtpUrlSupport, 32, 6);
        
        encoder0.encode(this.enforceChromeCtPolicy, 32, 7);
        
        encoder0.encode(this.http09OnNonDefaultPortsEnabled, 33, 0);
        
        encoder0.encode(this.pacQuickCheckEnabled, 33, 1);
        
        encoder0.encode(this.dangerouslyAllowPacAccessToSecureUrls, 33, 2);
        
        encoder0.encode(this.allowGssapiLibraryLoad, 33, 3);
        
        encoder0.encode(this.enableCertificateReporting, 33, 4);
        ...
        encoder0.encode(this.gssapiLibraryName, 128, false);
        
        if (this.ctLogs == null) {
            encoder0.encodeNullPointer(136, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.ctLogs.length, 136, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);

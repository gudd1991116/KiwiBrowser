...
org.chromium.url.mojom.Url url, String[] requestedProtocols, org.chromium.url.mojom.Url firstPartyForCookies, String userAgentOverride, WebSocketClient client) {
...
short code, String reason) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ADD_CHANNEL_REQUEST_ORDINAL: {
                        ...
                        getImpl().addChannelRequest(data.url, data.requestedProtocols, data.firstPartyForCookies, data.userAgentOverride, data.client);
                        return true;
                    }
    ...
    static final class WebSocketAddChannelRequestParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WebSocketAddChannelRequestParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new WebSocketAddChannelRequestParams(elementsOrVersion);
                    ...
                    result.userAgentOverride = decoder0.readString(32, false);
                    }
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.userAgentOverride, 32, false);

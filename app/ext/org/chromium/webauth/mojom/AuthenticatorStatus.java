...
public final class AuthenticatorStatus {
    ...
    public static final int AUTHENTICATOR_CRITERIA_UNSUPPORTED = NOT_ALLOWED_ERROR + 1;

    public static final int ALGORITHM_UNSUPPORTED = AUTHENTICATOR_CRITERIA_UNSUPPORTED + 1;

    public static final int EMPTY_ALLOW_CREDENTIALS = ALGORITHM_UNSUPPORTED + 1;

    public static final int USER_VERIFICATION_UNSUPPORTED = EMPTY_ALLOW_CREDENTIALS + 1;

    public static final int INVALID_DOMAIN = USER_VERIFICATION_UNSUPPORTED + 1;
    ...
    public static final int UNKNOWN_ERROR = NOT_FOCUSED + 1;

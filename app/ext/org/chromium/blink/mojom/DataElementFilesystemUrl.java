...
public final class DataElementFilesystemUrl extends org.chromium.mojo.bindings.Struct {
    ...
    public static DataElementFilesystemUrl deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static DataElementFilesystemUrl deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static DataElementFilesystemUrl decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        DataElementFilesystemUrl result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new DataElementFilesystemUrl(elementsOrVersion);
                {

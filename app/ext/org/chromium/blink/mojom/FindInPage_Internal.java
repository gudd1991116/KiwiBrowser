...
class FindInPage_Internal {
    ...
    private static final int STOP_FINDING_ORDINAL = 0;

    private static final int CLEAR_ACTIVE_FIND_MATCH_ORDINAL = 1;

    private static final int GET_NEAREST_FIND_RESULT_ORDINAL = 2;

    private static final int ACTIVATE_NEAREST_FIND_RESULT_ORDINAL = 3;

    private static final int FIND_MATCH_RECTS_ORDINAL = 4;
...
ActivateNearestFindResultResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(
                                    ACTIVATE_NEAREST_FIND_RESULT_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
                    new FindInPageActivateNearestFindResultResponseParamsForwardToCallback(callback));
...
FindMatchRectsResponse callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ACTIVATE_NEAREST_FIND_RESULT_ORDINAL: {
                        ...
                        getImpl().activateNearestFindResult(data.point, new FindInPageActivateNearestFindResultResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class FindInPageActivateNearestFindResultResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private FindInPageActivateNearestFindResultResponseParams(int version) {
            super(STRUCT_SIZE, version);
        }
        ...
        public static FindInPageActivateNearestFindResultResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static FindInPageActivateNearestFindResultResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static FindInPageActivateNearestFindResultResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            FindInPageActivateNearestFindResultResponseParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new FindInPageActivateNearestFindResultResponseParams(elementsOrVersion);
                    {
                    ...
                    result.numberOfMatches = decoder0.readInt(16);
                    }
                    {
                        
                    result.activeMatchOrdinal = decoder0.readInt(20);
                    }
                    {
                        
                    result.finalUpdate = decoder0.readBoolean(24, 0);
                    }
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.activeMatchRect, 8, false);
            
            encoder0.encode(this.numberOfMatches, 16);
            
            encoder0.encode(this.activeMatchOrdinal, 20);
            
            encoder0.encode(this.finalUpdate, 24, 0);
        }
    }

    static class FindInPageActivateNearestFindResultResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final FindInPage.ActivateNearestFindResultResponse mCallback;

        FindInPageActivateNearestFindResultResponseParamsForwardToCallback(FindInPage.ActivateNearestFindResultResponse callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(ACTIVATE_NEAREST_FIND_RESULT_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }

                FindInPageActivateNearestFindResultResponseParams response = FindInPageActivateNearestFindResultResponseParams.deserialize(messageWithHeader.getPayload());

                mCallback.call(response.activeMatchRect, response.numberOfMatches, response.activeMatchOrdinal, response.finalUpdate);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class FindInPageActivateNearestFindResultResponseParamsProxyToResponder implements FindInPage.ActivateNearestFindResultResponse {

        private final org.chromium.mojo.system.Core mCore;
        private final org.chromium.mojo.bindings.MessageReceiver mMessageReceiver;
        private final long mRequestId;

        FindInPageActivateNearestFindResultResponseParamsProxyToResponder(
                org.chromium.mojo.system.Core core,
                org.chromium.mojo.bindings.MessageReceiver messageReceiver,
                long requestId) {
            mCore = core;
        ...
        @Override
        public void call(org.chromium.gfx.mojom.Rect activeMatchRect, Integer numberOfMatches, Integer activeMatchOrdinal, Boolean finalUpdate) {
            FindInPageActivateNearestFindResultResponseParams _response = new FindInPageActivateNearestFindResultResponseParams();

            _response.activeMatchRect = activeMatchRect;

            _response.numberOfMatches = numberOfMatches;

            _response.activeMatchOrdinal = activeMatchOrdinal;

            _response.finalUpdate = finalUpdate;

...
public final class ManifestError extends org.chromium.mojo.bindings.Struct {
    ...
    public static ManifestError deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ManifestError deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static ManifestError decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new ManifestError(elementsOrVersion);
                {

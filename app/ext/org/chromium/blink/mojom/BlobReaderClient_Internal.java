...
class BlobReaderClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<BlobReaderClient, BlobReaderClient.Proxy> MANAGER =
            new org.chromium.mojo.bindings.Interface.Manager<BlobReaderClient, BlobReaderClient.Proxy>() {
        ...
        @Override
        public Stub buildStub(org.chromium.mojo.system.Core core, BlobReaderClient impl) {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements BlobReaderClient.Proxy {
...
long totalSize, long expectedContentSize) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(ON_CALCULATED_SIZE_ORDINAL)));
...
int status, long dataLength) {
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<BlobReaderClient> {

        Stub(org.chromium.mojo.system.Core core, BlobReaderClient impl) {
            super(core, impl);
        }
    ...
    static final class BlobReaderClientOnCalculatedSizeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BlobReaderClientOnCalculatedSizeParams deserialize(org.chromium.mojo.bindings.Message message) {
        ...
        public static BlobReaderClientOnCalculatedSizeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
    ...
    static final class BlobReaderClientOnCompleteParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static BlobReaderClientOnCompleteParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static BlobReaderClientOnCompleteParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();

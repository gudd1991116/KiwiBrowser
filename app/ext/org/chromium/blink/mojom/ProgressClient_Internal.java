...
class ProgressClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<ProgressClient, ProgressClient.Proxy> MANAGER =
            new org.chromium.mojo.bindings.Interface.Manager<ProgressClient, ProgressClient.Proxy>() {
        ...
        @Override
        public Stub buildStub(org.chromium.mojo.system.Core core, ProgressClient impl) {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements ProgressClient.Proxy {
...
long delta) {
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<ProgressClient> {

        Stub(org.chromium.mojo.system.Core core, ProgressClient impl) {
            super(core, impl);
        }
    ...
    static final class ProgressClientOnProgressParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ProgressClientOnProgressParams deserialize(org.chromium.mojo.bindings.Message message) {
         ...
         */
        public static ProgressClientOnProgressParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ProgressClientOnProgressParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }

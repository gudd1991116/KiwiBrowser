...
public class MisesPagerGridSnapHelper extends SnapHelper {
    ...
    protected RecyclerView.SmoothScroller createScroller(@NonNull RecyclerView.LayoutManager layoutManager) {
        if (!(layoutManager instanceof MisesPagerGridLayoutManager)) {
            return null;
        }
        if (mRecyclerView != null) {
            return new MisesPagerGridSmoothScroller(mRecyclerView, (MisesPagerGridLayoutManager) layoutManager);
        }
        return null;
    }
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        ...
        final MisesPagerGridLayoutManager manager = (MisesPagerGridLayoutManager) layoutManager;
    ...
    public View findSnapView(RecyclerView.LayoutManager layoutManager) {
        View snapView = null;
        if (layoutManager instanceof MisesPagerGridLayoutManager) {
            MisesPagerGridLayoutManager manager = (MisesPagerGridLayoutManager) layoutManager;
            reacquireSnapList(manager);
            switch (snapList.size()) {
                case 1: {
    ...
    public int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager, @NonNull View targetView) {
        ...
        if (layoutManager instanceof MisesPagerGridLayoutManager) {
            ...
            if (viewDecoratedStart <= layoutCenter) {
                ...
                dx = MisesPagerGridSmoothScroller.calculateDx(manager, snapRect, targetRect);
                dy = MisesPagerGridSmoothScroller.calculateDy(manager, snapRect, targetRect);
            } else {
                //向后前进
     ...
     * @param manager
     */
    private void reacquireSnapList(MisesPagerGridLayoutManager manager) {
        if (!snapList.isEmpty()) {
            snapList.clear();
        }
    ...
    static int calculateDxToNextPager(MisesPagerGridLayoutManager manager, Rect targetRect) {
    ...
    static int calculateDyToNextPager(MisesPagerGridLayoutManager manager, Rect targetRect) {

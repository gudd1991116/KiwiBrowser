...
public class MisesPagerGridSmoothScroller extends LinearSmoothScroller {
    ...
    MisesPagerGridSmoothScroller(@NonNull RecyclerView recyclerView, @NonNull MisesPagerGridLayoutManager layoutManager) {
    ...
    static int calculateDx(MisesPagerGridLayoutManager manager, Rect snapRect, Rect targetRect) {
    ...
    static int calculateDy(MisesPagerGridLayoutManager manager, Rect snapRect, Rect targetRect) {
    ...
    static int calculateDx(MisesPagerGridLayoutManager manager, Rect snapRect, Rect targetRect, boolean isLayoutToEnd) {
        if (!manager.canScrollHorizontally()) {
            return 0;
        }
    ...
    static int calculateDy(MisesPagerGridLayoutManager manager, Rect snapRect, Rect targetRect, boolean isLayoutToEnd) {
        if (!manager.canScrollVertically()) {
            return 0;
        }
